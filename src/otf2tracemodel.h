#ifndef OTF2TRACEMODEL_H
#define OTF2TRACEMODEL_H
...
class OTF2TraceModel :
    public TraceModel,
    public std::enable_shared_from_this<OTF2TraceModel>
{
public: /** members */
    typedef std::shared_ptr<OTF2TraceModel> OTF2TraceModelPtr;

public: /** methods */
    OTF2TraceModel(const QString& filename);
    ~OTF2TraceModel();
